...
const DeleteConfirmModal = ({ setShowDeleteModal, deleteTask, setIdForDelete }) => {
    return (
        <>
            ...
            <div className='fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] drop-shadow-lg w-full md:w-1/5 bg-white p-5 rounded-md'>
                ...
                <div className="flex justify-center gap-5 mt-5">
                    <button className="px-3 py-1 bg-blue-600 rounded-md text-white" onClick={() => { setShowDeleteModal(false); setIdForDelete('') }}>Cancel</button>
